...
rs <- ggplot() +
  ...
  ggtitle("(A) Provisions Introduced (No Covariates)")
...
race_intro <- ggplot() +
  ...
  labs(x = "White Share of Population",
       ...
       linetype = "Unified Republican Control",
       shape = "Unified Republican Control") +
  ggtitle("(C) Provisions Introduced (With Covariates)")
# race_intro
...
rp <- ggplot() +
  ...
  labs(x = "White Share of Population",
       ...
       linetype = "Unified Republican Control",
       shape = "Unified Republican Control") +
  ggtitle("(B) Provisions Passed (No Covariates)")
...
race_pass <- ggplot() +
  ...
  labs(x = "White Share of Population",
       ...
       linetype = "Unified Republican Control",
       shape = "Unified Republican Control") +
  ggtitle("(D) Provisions Passed (With Covariates)")
# race_pass
