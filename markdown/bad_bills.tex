...
The primary independent variables for the district-level analyses are the white share of the district \emph{and} the white share of the state. These are included to test whether the influence of the whiteness of a district on the probability that a lawmaker sponsors a restrictive bill is influenced by state-level factors. I also incorporate survey data from the Cooperative Election Study (CES) in 2020 to test whether districts' racial resentment scores are associated with these sponsorships. The 2020 CES asks white voters how strongly they agree (on a scale of 1 to 5) with two statements related to racial resentment: \emph{Irish, Italians, Jewish and many other minorities overcame prejudice and worked their way up. Blacks should do the same without any special favors} and \emph{Generations of slavery and discrimination have created conditions that make it difficult for blacks to work their way out of the lower class}. I reverse code agreement with the first statement, such that higher scores for both statements are associated with higher levels of racial resentment. Respondents' racial resentment scores are calculated as the mean of their response to these two questions. I retain only the responses of white respondents.

While the CES data do not include respondents' home legislative districts, the survey \emph{does} make home ZIP codes available. Respondents are assigned to the legislative district in which the plurality of each ZIP code's population live. This will not perfectly capture respondents who live in ZIP codes that cross district lines; however, about this approach classifies about 80\% of Americans into their correct lower legislative district, and about 90\% of Americans into the correct upper legislative district. In the Supplementary Information, I show that the results hold if I retain only respondents who live in ZIP codes that fall entirely within a single legislative district.
...
I also test the effect of partisanship and competitiveness along the lines of past scholarship, but here at the \emph{district} level. This past work would predict that \textbf{H3a}: lawmakers from competitive districts controlled by Republicans are the most likely to support restrictive voting legislation. If, however, the sponsorship of such legislation is tied more to racial threat and signalling to an aggreived base, I predict that \textbf{H3b}: representatives from the most conservative districts were the most likely to sponsor these bills.

Finally, I test the relationship between whites' racial resentment and lawmaker sponsorship of restrictive bills, hypothesizing that \textbf{H4}: Districts where white voters have higher levels of racial resentment were more likely to be represented by legislators that sponsored restrictive voting provisions.
...
\caption{\label{fig:mef-comp}Provisions Sponsored by Chamber}\label{fig:mefs-comp}
\end{figure}

I turn next to the relationship between estimated racial resentment among whites and legislators' sponsorship of restrictive bills. Figure \ref{fig:mef-rr} plots the predicted probabilities of sponsorship, both before and after controlling for other covariates (the regression table can be found in the SI). The top panels demonstrate a strong bivariate relationship between racial resentment and sponsorship: districts where white respondents to the CES were more racially resentful were far more likely to be represented by a lawmaker who sponsored a restrictive bill. This is especially true in the upper chamber.
...
\caption{\label{fig:mef-rr}Provisions Sponsored by Chamber}\label{fig:mefs-rr}
\end{figure}

These relationships are moderated by the inclusion of sociodemographic controls, especially the partisan measures. Nevertheless, the relationship between racial resentment and restrictive bill sponsorship approaches statistical signficance even after controlling for these other factors. In both chambers the relationship is still substantively large, with relatively low p-values (0.076 in the lower and 0.102 in the upper chamber models).
